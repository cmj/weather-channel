...
Pg6_C1_Zip = 48127 #Zip code for first city on page 6, used by NOAA to determine weather dat
...
#Set weather data for pages 6-8
    ...
    if current_time.hour == UpdateHour:
     ...
     if startUpdate == 1:
       ...
       Pg8_C7_curr_weaval = pullData(Pg8_C7_Zip)
       s8 = "Done"
       UpdateHour = current_time.hour + 1
