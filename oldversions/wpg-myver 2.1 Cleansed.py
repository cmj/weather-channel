...
def shortFDetermine(dirtyIn): #Used to determine forcast, called by pages 1-3, 6-8 (4 and 5 are currently disabled)
    ...
    if (PageNum == 1):
      ...
      #  PageNum = PageNum + 1 #remove to bring back page 2
       ...
       # PageNum = PageNum +3 #Added by TS to skip forcast continued pages, comment out or remove this line to bring them back
        ...
        def Pg3_temp(weaval): #Used by Page 3 to determine temperature. I'd like to use this for the enitre program eventually
           Pg3_tDirty = (weaval[140:150])
           Pg3_temp = re.sub("\D", "", Pg3_tDirty)
           return Pg3_temp
        
        def Pg3_Forecast(weaval): #Used by Page 3 to determine forecast. I'd like to use this for the enitre program eventually
           Pg3_fDirty = (weaval[450:580])
           Pg3_dayF = shortFDetermine(Pg3_fDirty)
           return Pg3_dayF

        def Pg3_Precip(weaval): #Used by Page 3 to determine precipitation. I'd like to use this for the enitre program eventually
           Pg3_precipDirty = (weaval[255:275])
           Pg3_precip = re.sub("\D", "", Pg3_precipDirty)
           return Pg3_precip

        Pg3_day_1_Forecast = Pg3_Forecast(Pg3_day_1_Weaval) #Calls forecast function to determine forecast for each day
        Pg3_day_2_Forecast = Pg3_Forecast(Pg3_day_2_Weaval)
        Pg3_day_3_Forecast = Pg3_Forecast(Pg3_day_3_Weaval)
        Pg3_day_4_Forecast = Pg3_Forecast(Pg3_day_4_Weaval)
        Pg3_day_5_Forecast = Pg3_Forecast(Pg3_day_5_Weaval)
        Pg3_day_6_Forecast = Pg3_Forecast(Pg3_day_6_Weaval)

        Pg3_day_1_temp = Pg3_temp(Pg3_day_1_Weaval) #Calls temperature function to determine temperature for each day
        Pg3_day_2_temp = Pg3_temp(Pg3_day_2_Weaval)
        Pg3_day_3_temp = Pg3_temp(Pg3_day_3_Weaval)
        Pg3_day_4_temp = Pg3_temp(Pg3_day_4_Weaval)
        Pg3_day_5_temp = Pg3_temp(Pg3_day_5_Weaval)
        Pg3_day_6_temp = Pg3_temp(Pg3_day_6_Weaval)

        Pg3_day_1_Precip = Pg3_Precip(Pg3_day_1_Weaval) #Calls precipitation function to determine precipitation for each day
        Pg3_day_2_Precip = Pg3_Precip(Pg3_day_2_Weaval)
        Pg3_day_3_Precip = Pg3_Precip(Pg3_day_3_Weaval)
        Pg3_day_4_Precip = Pg3_Precip(Pg3_day_4_Weaval)
        Pg3_day_5_Precip = Pg3_Precip(Pg3_day_5_Weaval)
        Pg3_day_6_Precip = Pg3_Precip(Pg3_day_6_Weaval)
