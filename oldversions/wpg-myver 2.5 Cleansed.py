...
#Started on June 27, 2024, last updated July 27, 2024
...
#2.4
    #Fixed issue where page 1 showed 0 AM at midnight instead of 12 AM
    #Added ability to automatically update weather data, should occour every 30-60 minutes, depending on circumstances
    #Made date/time setup into functions, making it possible/far easier to update date/time as program runs
    #Attempted to make page 1 update, doesn't work, moving on to next version (I have other changes planned and want to separate versions, there's a method to my madness
    #increased from 1042 to 1172 lines
#V2.5
    #Made page 6-8 variables on one line per city, vs each detail being on it's own line (decrease line count from 1172 to 1116
    #Simplified weatherDataUpdate function
    #Moved Hour_String setup to pg1TimeSet function, to fix issue with time not updating on page 1
    #Removed need for future.py file. weekData function has been added to replace it
    #Added various comments
    #Changed page 8 if/else statement to use == instead of >, moved + 1 to else statement
    #Added updateHour function to fix issue with not updating after 11pm
    #Increased from 1172 to 1094 lines
#Fixes
...
updateTimer = 300000 #1800000 this has been changed to 5 minutes for testing purposes, it will be 30 eventually
...
#Set weather data for pages 6-8
    ...
    if current_time.hour == UpdateHour:
     ...
     if startUpdate == 1:
       ...
       print("Not on correct page yet!")
       print(startUpdate)
    else:
     print("Update not needed yet!")
...
#Get extra forcast data, this is needed for Pressure and visibility
def extraData():
    n = NOAA()
